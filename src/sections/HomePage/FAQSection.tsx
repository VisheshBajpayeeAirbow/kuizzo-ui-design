...
const FAQSection = () => {
  return (
    <section className="relative md:mx-auto md:w-[90%] lg:w-[1400px]">
      <Image
        src={SemiCircle}
        alt="semicircle"
        className="absolute right-[5.87rem] top-[6rem] hidden md:block"
      />
      <div className="flex flex-col gap-[2.12rem] md:gap-[1.37rem] justify-center items-center mt-[5.19rem] md:mt-[7.37rem]">
        ...
        />
        <p className="text-sub-heading text-nowrap md:text-[1.5625rem] leading-[150%]">
          We thought you might have some questions...
        </p>
      </div>

      <div className="mt-[3.94rem] md:mt-[5rem]">
