...
const Sidebar = () => {
  return (
    // desktop view
    <aside className="hidden md:inline-flex h-auto flex-col items-start flex-shrink-0 bg-top-flashcards-card-background rounded-[1.25rem] border-[1px] border-opacity-50 border-dashboard-sidebar-border">
      {/* profile section */}
